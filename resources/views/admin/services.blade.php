...
@section('content')
        ...
        <div class="jumbotron">
            <a href="#newcategory" class="btn btn-primary" data-toggle="modal"> Add new Services</a>

            <div class="card-header">
              <h1 class="font-weight-bold text-center">Manage Services</h1>
            </div>
            @if(session('success'))
            ...
            <div class="card-body">
              ...
              <tr>
                @php
                $picture= $service->picture ? $service->picture->file :"";
                 @endphp
                <td scope="row">{{ ++$i }}</td>
                ...
                <form action="{{ route('services.store') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea type="text" placeholder="Descriptions" name="description" id="name" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" autocomplete="" autofocus>
                        {{ old('description') }}
                        </textarea>
                ...
                <form id="editform" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea type="text" placeholder="Descriptions" name="description" id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" autocomplete="" autofocus>
                        {{ old('description') }}
                        </textarea>
                        @if ($errors->has('description'))
                                  <span class="invalid-feedback" role="alert">
