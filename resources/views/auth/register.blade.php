...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h3 class="text-center font-weight-bold">{{ __('Register') }}</h3></div>
                <div class="card-body">
                ...
                <form>
                    <div class="form-group row">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/login/facebook" class="text-primary"><span class="badge badge-primary p-2 mr-2 "><span class="fa fa-facebook " style="font-size: 20px"></span></span>Login With Facebook</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/login/google" class="text-primary"><span class="badge badge-primary p-2 mr-2 "><span class="fa fa-google" style="font-size: 20px"></span></span>Login With Gmail</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <a href="facebook" class="text-primary"><span class="badge badge-primary p-2 mr-2 "><span class="fa fa-twitter" style="font-size: 20px"></span></span>Login With Twitter</a>
                                </div>
                            </div>
                        </div>
                    </div>
