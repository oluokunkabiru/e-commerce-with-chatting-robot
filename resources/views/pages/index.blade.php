            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix {{ $categorys }} fresh-meat">
                <div class="featured__item">
                    ...
                    <div class="product__item__text">
                            <h4><a href="{{ route('productDetails' , ['id' => $product->slug]) }}" class="text-dark font-weight-bold">{{ ucwords($product->product_name) }}</a></h4>
                            <div class="card-">
                                <div class="card-header"><h4><span class="fa">&#8358;</span>{{ $product->newprice }}</h4>
                                    <br>
                                    <form action="{{ route('AddtoCart.store')}}" method="post" style="display: inline">
                                        <input type="hidden" name="id" value="{{ $product->id }}">
                                        {{ csrf_field() }}
                                        <button type="submit" class="btn btn-sm btn-rounded btn-primary"> Order now <i  class="fa fa-shopping-cart"></i></button>
                                    </form>
